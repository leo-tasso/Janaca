 ...
 * 
 */
public class StateTablutTest extends State implements Serializable {

	private static final long serialVersionUID = 1L;

	public StateTablutTest() {
		super();
		...
		this.board[6][3] = Pawn.WHITE;
		this.board[6][5] = Pawn.WHITE;
...
//		this.board[4][7] = Pawn.BLACK;
	...
	public StateTablutTest clone() {
		StateTablutTest result = new StateTablutTest();
	...
	public boolean equals(Object obj) {
		...
		if (this.getClass() != obj.getClass())
			return false;
		StateTablutTest other = (StateTablutTest) obj;
		if (this.board == null) {
			if (other.board != null)
				return false;
		} else {
